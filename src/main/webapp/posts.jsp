	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link" href="todos.jsp">Tareas</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="albums.jsp">Álbumes</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="photos.jsp">Fotos</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="posts.jsp">Publicaciones</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="comments.jsp">Comentarios</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="users.jsp">Usuarios</a>
					</li>
				</ul>
			</div>
		</div>
